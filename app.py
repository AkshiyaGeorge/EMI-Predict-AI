...
with tab5:
    ...
    # ✅ Reliable local/cloud detection
    ...
    if is_running_locally():
        try:
            ...
            st.error("❌ Failed to connect to MLflow. Make sure the server is running locally.")
            st.exception(e)
    else:
        # 🚫 Cloud fallback message
        st.info(
            "⚠️ MLflow tracking is disabled in cloud mode. To enable monitoring, run locally with MLflow server active.\n\n"
